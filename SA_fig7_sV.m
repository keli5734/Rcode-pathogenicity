...
ratio = 1:0.25:10;
s_V = ratio * sV_base;
TD_change_HP = zeros(1, length(s_V));
AUCD_change_HP = zeros(1, length(s_V));
...
[~,y_inf_HP] = ode15s(@Model, report_time_inf, init_inf, options,...
                       s_M, delta_MR,...
                       s_V(j), k1, k2, alpha1,D_50, k_m1, k_m2, V50_M,...
                       delta_M1,delta_M2,...
...
% 
% total_macrophags = y_inf_HP(:,1) + y_inf_HP(:,2) + y_inf_HP(:,3);
% 
% figure(10)
% semilogy(report_time_inf, y_inf_HP(:,6),'r')
% hold on 
% ylim([1e+0,1e+8])
% 
% figure(11)
% plot(report_time_inf, y_inf_HP(:,2)./ total_macrophags, 'b')
% hold on 
% plot(report_time_inf, y_inf_HP(:,3)./ total_macrophags, 'r')
...
ratio  = 1:0.25:10;
s_V = ratio * sV_base;
TD_change_LP = zeros(1, length(s_V));
AUCD_change_LP = zeros(1, length(s_V));
...
% total_macrophags = y_inf_LP(:,1) + y_inf_LP(:,2) + y_inf_LP(:,3);

% figure(10)
% semilogy(report_time_inf, y_inf_LP(:,6),'b')
% hold on 
% ylim([1e+0,1e+5])
% 
% figure(13)
% plot(report_time_inf, y_inf_LP(:,2)./ total_macrophags, 'b')
% hold on 
% plot(report_time_inf, y_inf_LP(:,3)./ total_macrophags, 'r')
